...
-The first line of all scripts must be exactly #!/usr/bin/env bash
-The second line of the bash scripts should be a comment explaing what is the script doing
*
...
# AUTHOR
*Mondliwethu Vundla (Github)[https://www.github.com/mondlivundla]  |  (twitter)[https://www.twitter/mondlivundla1]
